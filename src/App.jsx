...
function App() {
  ...
  return (
    <>
      ...
      <div className="w-full relative min-h-screen mt-32 px-10">
        {showCanvas &&
        ...
        <div className="carousel rounded-md py-36">
      ...
      <div ref={footerRef} className="w-full h-[40vh] bg-black">
          <footer className="footer bg-base-300 text-base-content p-10 h-[40vh] relative">
            {showCanvas &&
